...
testfiles="bif01.erl exception01.erl fun??.erl simpl_*.erl tuple.erl small.erl length.erl catches.erl catch_empty.erl random_test.erl test??.erl mode_errors.erl switch_mix.erl"
